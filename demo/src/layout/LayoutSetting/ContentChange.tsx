    ...
    <div className={classNames('RA-setting-Row', 'RA-setting-contentControl')}>
      <div className="RA-setting-settingItem">
        <div className="RA-setting-settingItem-Label">
          {localeContent['layoutSetting.contentWidth'] || '内容区域宽度'}
        </div>
        <Select
        ...
        >
          <Select.Option value="flow">
            {localeContent['layoutSetting.flowContent'] || '流式'}
          </Select.Option>
          <Select.Option value="max-width" disabled={!isHorizontalNavigator}>
            {localeContent['layoutSetting.maxWidth'] || '定宽'}
          </Select.Option>
        </Select>
      </div>
      <Tooltip
        placement="left"
        title={
          isInlineLayout ? localeContent['layoutSetting.splitModeOnly'] || '仅在分列布局下起效' : ''
        }
      >
        <div className="RA-setting-settingItem">
          <div className="RA-setting-settingItem-Label">
            {localeContent['layoutSetting.fixHeader'] || '固定 Header'}
          </div>
          <Switch
      ...
      >
        <div className="RA-setting-settingItem">
          <div className="RA-setting-settingItem-Label">
            {localeContent['layoutSetting.fixSiderBar'] || '固定侧边菜单'}
          </div>
          <Switch
  ...
  const DisplayBlock = (
    ...
    >
      <div className="RA-setting-title">
        {localeContent['layoutSetting.contentSetting'] || '内容控制'}
      </div>
      <div className="RA-setting-settingItem">
        <div className="RA-setting-settingItem-Label">
          {localeContent['layoutSetting.showHeader'] || '显示 header'}
        </div>
        <Switch
          checked={showHeader}
          defaultChecked
      ...
      >
        <div className="RA-setting-settingItem">
          <div className="RA-setting-settingItem-Label">
            {localeContent['layoutSetting.showSiderBar'] || '显示侧边菜单'}
          </div>
          <Switch
            disabled={isHorizontalNavigator}
